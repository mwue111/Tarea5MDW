...
public class MDW_tarea6 {
    ...
    public static void main(String[] args) {
		...
		selectionSort.imprimeArray(array1);
		selectionSort.ordenaArray(array1);
		selectionSort.imprimeArray(array1);
		System.out.println();
		
		int[] array2 = { 3, 1, 23, 18, 41, 4, 44, 7, 16, 2 };
		int[] array3;
		selectionSort.imprimeArray(array2);
		array3=selectionSort.ordenaArray2(array2);
		selectionSort.imprimeArray(array3);
    }
